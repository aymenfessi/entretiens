...
- J'ai plus de [5 années] d'expérience en tests logiciels. J'ai travaillé dans divers rôles, notamment en tant qu'analyste QA, ingénieur de test et chef d'équipe de tests. Mon expérience couvre une gamme de domaines, y compris [mentionnez des domaines pertinents, par exemple, applications Web, mobiles, systèmes embarqués].

- Actuellement, je travaille en tant que Responsable Automatisation Test et QA chez Biptag, une entreprise qui développe un outil de mobilité commerciale pour les exposants des salons professionnels. Mon rôle consiste à automatiser les tests de leur application web, que ce soit sur desktop, mobile ou via des QR Codes, ainsi que les services web associés. J'assure également l'automatisation de la validation des fonctionnalités métiers de l'application, prépare les campagnes de tests par release et rédige des rapports de test détaillés. Je travaille en étroite collaboration avec les développeurs pour le suivi des anomalies et j'assure le support client et l'assistance technique. Les outils et technologies que j'utilise comprennent Appium, Python, Java, Selenium, Katalon, Postman, Linkedin Sales Navigator, Mantis, et Brevo (SendinBlue), ainsi que des méthodologies basées sur le BDD (Behavior-Driven Development).

- Avant cela, chez Biptag Digital Events, j'ai eu l'opportunité d'exercer plusieurs rôles, dont Testeur QA, Product Manager, et Scrum Master. Mon travail consistait à rédiger des user stories, concevoir les interfaces utilisateur en collaboration avec les designers, automatiser la validation des fonctionnalités métiers et gérer le cycle de développement de l'application. Les technologies que j'ai utilisées incluent Jitsi, PHP, CodeIgniter, Trello et Balsamiq.

- Auparavant, chez BSmartDoc, j'ai été Team Lead. J'ai contribué à la conception de solutions, à la préparation et à l'exécution de tests fonctionnels, ainsi qu'à la mise en service de ces solutions. J'ai également eu l'occasion de travailler avec des outils tels que PHP, CodeIgniter, Mantis, WordPress, et PHPMyFAQ.

- Mon parcours professionnel a également inclus une expérience en tant que Testeur Web et Mobile chez Biptag, où j'ai rédigé des spécifications fonctionnelles, préparé et exécuté des campagnes de tests, et travaillé en étroite collaboration avec les développeurs pour assurer la qualité du produit.

- Avant de me spécialiser dans le domaine du test logiciel, j'ai travaillé en tant que Team Leader et Développeur chez Tunisie Conseil, où j'ai conçu et développé divers sites web avec différentes technologies et CMS.

- Pour ce qui est de mes compétences techniques, je suis à l'aise avec les systèmes d'exploitation Linux et Microsoft Windows, ainsi qu'avec des langages de programmation tels que Java, Python, PHP et JavaScript. J'utilise régulièrement des IDE et des outils comme PyCharm, Android Studio, PhpStorm, Eclipse, et Postman. En ce qui concerne les tests, je maîtrise des outils tels que Selenium, Katalon, et Appium. Je suis également compétent dans le développement web, avec des compétences en CodeIgniter, HTML, Google APIs, jQuery, Angular, CSS et Bootstrap. Enfin, je suis familier avec plusieurs CMS, y compris PHPMyFAQ, Joomla, WordPress, OpenCart, Moodle et PrestaShop, ainsi qu'avec la gestion de bases de données MySQL.
